...
urlpatterns = [
    ...
    path('show_groups/', studentview.show_groups, name = 'show_groups'),
    path('show_student_material/', studentview.show_student_material, name = 'show_student_material'),
    path('student_show_pdf/', studentview.student_show_pdf, name = 'student_show_pdf'),
